...
<body>
            ...
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu fade-up m-0">
                        ...
                        <a href="omics.php" class="dropdown-item active">Omics</a>
    ...
    <div id="popup1" class="overlay">
	    <div class="popup">
		    ...
		    <div class="content">
			<p>To view the full contents of the Omics Data, search for the hashtag '#'.<br> Alternatively, you can enter a specific keyword or ID to view specific data.</p>    
            </div>
	    </div>
    </div>
