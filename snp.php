...
<body>
            ...
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu fade-up m-0">
                        ...
                        <a href="snp.php" class="dropdown-item active">SNP</a>
                    </div>
                </div>
    ...
    <div class="container-fluid page-header py-5 mb-5">
        <div class="container py-5">
            <h1 class="display-3 text-white mb-3 animated slideInDown">SNP</h1>
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a class="text-white" href="#">Home</a></li>
                    <li class="breadcrumb-item"><a class="text-white" href="#">Pages</a></li>
                    <li class="breadcrumb-item text-white active" aria-current="page">SNP</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div id="popup1" class="overlay">
	    <div class="popup">
		    ...
		    <div class="content">
			<p>Click on the URL to view the full details of the SNP.</p>
            </div>
	    </div>
    </div>
		                            ...
		                            while($row = $result->fetch_assoc()) {
                                        echo "<tr>
                                            <td>" . $row["S.No"] . " </td>
                                                    ...
                                                    <td>" . $row["MAF"] . "</td>
                                                    <td><a href=" . $row["GWAS_Catalog"] . "<button>Gwas Catalog Link</button></a></td>
                                                    <td><a href=" . $row["dbSNP"] . "<button>dbSNP Link</button></a></td>
                                                    <td><a href=" . $row["SNPedia"] . "<button>SNPedia Link</button></a></td>
                                                 </tr>";
                                                 }
                                        $connection->close();
                                    ?>
