...
<body>
    ...
    <div class="container-fluid page-header py-5 mb-5">
        <div class="container py-5">
            <h1 class="display-3 text-white mb-3 animated slideInDown">Proteins</h1>
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a class="text-white" href="#">Home</a></li>
                    <li class="breadcrumb-item"><a class="text-white" href="#">Databases</a></li>
                    <li class="breadcrumb-item text-white active" aria-current="page">Proteins</li>
                </ol>
            </nav>
        </div>
    </div>
...
<div class="box">
    ...
    <div id="popup1" class="overlay">
	    <div class="popup">
		    ...
		    <div class="content">
			 <p>To view the full contents of the Protein Sequence, search for the hashtag '#'.<br> Alternatively, you can enter a specific keyword or ID to view specific data.</p>    
            </div>
	    </div>
    </div>
                            ...
                            <tbody>
                                <?php 
                                    ...
                                    if(isset($_GET['search']))
                                    {
                                        ...
                                        if($filtervalues == "#")
                                        {
                                            $query="SELECT * From protein_seq";
                                        }
                                        else{
                                        $query = "SELECT * FROM protein_seq WHERE CONCAT(Title,Accession_ID,GI,FASTA) LIKE '%$filtervalues%' ";
                                        }
                                        ...
                                        if(mysqli_num_rows($query_run) > 0)
                                        {
                                            foreach($query_run as $items)
                                            {
                                                ...
                                                <tr>
                                                    <td><?= $items['Title']; ?></td>
                                                    <td><?= $items['Sequence_Length']; ?></td>
                                                    <td><?= $items['Accession_ID']; ?></td>
                                                    <td><?= $items['GI']; ?></td>
                                                    <td><?= $items['FASTA']; ?></td>
                                                </tr>
                                                <?php
