...
<body>
            ...
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu fade-up m-0">
                        <a href="genes.php" class="dropdown-item active">Genes</a>
    ...
    <div id="popup1" class="overlay">
	    <div class="popup">
		    ...
		    <div class="content">
			<p>To view the full contents of the Gene Data, search for the hashtag '#'.<br> Alternatively, you can enter a specific keyword or ID to view specific data.</p>    
                        ...
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th>Gene Symbol</th>
                                    <th>Aliases</th>
                                    <th>Functional Annotaion</th>
                                    <th>Location in the Chromosome</th>
                            ...
                            <tbody>
                                <?php 
                                    ...
                                    if(isset($_GET['search']))
                                    {
                                        ...
                                        $query = "SELECT * FROM genes WHERE CONCAT(GeneID,Symbol,Aliases,description,chromosome,genomic_nucleotide_accession_version,OMIM) LIKE '%$filtervalues%' ";
                                        }
                                        ...
                                        if(mysqli_num_rows($query_run) > 0)
                                        {
                                            foreach($query_run as $items)
                                            {
                                                ...
                                                <tr>
                                                    <td><?= $items['GeneID']; ?></td>
                                                    <td><i><?= $items['Org_name']; ?></i></td>
                                                    <td><?= $items['Symbol']; ?></td>
                                                    <td><?= $items['Aliases']; ?></td>
                                                    <td><?= $items['description']; ?></td>
                                                    <td><?= $items['map_location']; ?></td>
                                                    <td><?= $items['genomic_nucleotide_accession_version']; ?></td>
                                                    <td><?= $items['OMIM']; ?></td>
                                                </tr>
                                                <?php
                                            }
