            ...
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu fade-up m-0">
                        ...
                        <a href="testimonial.html" class="dropdown-item">Clinical Trials</a>
...
<?php
        ...
        <thead>
			...
			while($row = $result->fetch_assoc()) {
                if ($val == $row['GeneID'] || $val == $row["tax_id"] || $val ==$row["Org_name"] ){
                echo "<tr>
                    <td>" . $row["GeneID"] . " </td>
				    <td>" . $row["tax_id"] . "</td>
                    <td>" . $row["Org_name"] . "</td>
