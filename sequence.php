            ...
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu fade-up m-0">
                        ...
                        <a href="quote.php" class="dropdown-item">Protein</a>
                        <a href="404.php" class="dropdown-item">Structure</a>
                        <a href="team.php" class="dropdown-item active">Omics</a>
                        <a href="testimonial.php" class="dropdown-item">Clinincal Trials</a>
                            ...
                            <tbody>
                                <?php 
                                    ...
                                    if(isset($_GET['search']))
                                    {
                                        ...
                                        $query = "SELECT * FROM omics WHERE CONCAT(id,source,title,description,title,organisms,omicsType) LIKE '%$filtervalues%' ";
